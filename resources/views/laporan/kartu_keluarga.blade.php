...
@section('title', 'Laporan Data Kartu Keluarga')

@section('breadcrumb')
    @parent
    <li class="breadcrumb-item active">Laporan Data Kartu Keluarga</li>
@endsection
           ...
           <p style="margin-bottom: 20px; font-size: 15px;">
            ...
            <x-card>
                <x-slot name="header">
                    ...
                    <a href="{{ route('laporan.kartu_keluarga_pdf', compact('start', 'end'))}}" target="_blank" class="btn btn-danger"><i
                            class="fas fa-file-pdf"></i> Cetak PDF</a>
                    <a href="{{ route('laporan.kartu_keluarga_excel')}}" target="_blank" class="btn btn-success"><i
...
<script>
    ...
    table = $('.table').DataTable({
        ...
        ordering: false,
        ajax: {
            url: '{{ route('laporan.data_kartu_keluarga', compact('start', 'end')) }}',
        },
        columns: [
